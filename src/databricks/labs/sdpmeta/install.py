...
class WorkspaceInstaller:
    def __init__(
        self, ws: WorkspaceClient, *, prefix: str = "sdp-meta", promtps: bool = True
    ):
    ...
    def run(self):
        logger.info(f"Installing SDP-META v{self._version}")
        self._configure()
    ...
    def _configure(self):
        try:
            ...
            logger.info("SDP META is already installed.")
            return
